...
設計ドキュメントは本リポジトリの [docs/](./)(基本設計 06・詳細設計 07 ほか)を参照。
本書は Phase 1.0(CLI / Claude / SQLite)実装のセットアップ・使い方・テストのガイド。
...
| `EGO_LLM_ADAPTER` | `claude` | LLM アダプタ(`codex` = Codex CLI 経由の OpenAI 系。テスト用途) |
